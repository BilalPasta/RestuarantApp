...
import { Container, Header, Content, Item, Input,Body ,Right,Button,Divider} from 'native-base';
  ...
  render() {
    return (
      <Container>
        ...
        <AppHeader left={    <TouchableOpacity 
        activeOpacity={0.7}  onPress={()=>{
      this.props.navigation.goBack()
          }} >
               
            <CachedImage source={require('../../assets/images/back.png')} style={{width:30,height:30}}/>
          </TouchableOpacity>} title="ABOUTUS" RightBar={<Right >
          <TouchableOpacity
          activeOpacity={0.7}
              transparent
              onPress={() => this.props.navigation.navigate('CardListPage')}
            >
                   <CachedImage source={require('../../assets/images/cart.svg')}  style={{width:30,height:30}}/>
...
Hanifia is the oldest and the best in the business by a
 good healthy and tasty mile. Through its artistry, Hanifia can turn routine meal
  time in to a celebration.
          ...
          {/* <CachedImage source={{uri:'http://hanifia.com/_assets/images/about2.jpg'}}/> */}
          </View>
          </ScrollView>
  </View>
